...
import { c as Route, u as useNavigate } from "./router-C3nMhQ1W.js";
import { B as BottomNav } from "./BottomNav-DeJo6lv4.js";
import { a as useTripActions, g as useExploreRoutes } from "./tripStore-Dcq5c_LT.js";
import { F as Flame } from "./flame-DCUqwoln.js";
...
import { C as ChevronLeft } from "./chevron-left-wCUXvlBx.js";
import { S as Share2, C as ChevronDown } from "./share-2-CAwfg6P2.js";
import { E as Ellipsis } from "./ellipsis-BbuyXMkZ.js";
import { C as Copy } from "./copy-Crk3R6i_.js";
import { M as MapPin } from "./map-pin-fh5TPeje.js";
import { C as Check } from "./check-Cdq0pvHb.js";
...
function RouteCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "grid grid-cols-[30%_1fr] gap-2 rounded-[16px] bg-white pr-1 shadow-[0_8px_24px_rgba(38,43,70,.08)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-w-0 py-1.5 pr-1", children: [
      ...
      route.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 flex flex-wrap gap-1", children: route.tags.slice(0, 4).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-[#f3f1ff] px-2 py-[2px] text-[9px] font-bold text-[#6554e8]", children: t }, t)) }),
