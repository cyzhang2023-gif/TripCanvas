...
import { C as Compass, B as BottomNav } from "./BottomNav-BgqiKBqP.js";
import { f as useFeaturedRoutes } from "./tripStore-cMDVB5jQ.js";
...
function InspirationMap() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell min-h-screen bg-[#f5f6fa] pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-3 mt-2 overflow-hidden rounded-[20px] shadow-md", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[#dce8f0]", style: {
        transform: `scale(${zoom.scale}) translate(${zoom.x}%, ${zoom.y}%)`,
        transition: "transform 0.6s cubic-bezier(0.4, 0, 0.2, 1)",
        transformOrigin: "center center"
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/world-map.svg?v=3", alt: "", className: "h-full w-full", draggable: false }) }),
