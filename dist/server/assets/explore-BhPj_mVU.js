...
import { d as Route, u as useNavigate } from "./router-D-67bGNW.js";
import { B as BottomNav } from "./BottomNav-B3kl0Tsd.js";
import { I as Img } from "./Img-tjwatT2O.js";
import { b as RatingSummary } from "./RatingSummary-Cfh5zWG_.js";
import { a as useTripActions, h as useExploreRoutes } from "./tripStore-D1dKS6e8.js";
...
import { S as Share2 } from "./share-2-Ba4QQL0v.js";
import { E as Ellipsis } from "./ellipsis-C7lYLo4r.js";
import { C as Copy } from "./copy-B6CU3ZsX.js";
import { M as MapPin } from "./map-pin-BYq5lxXL.js";
import { C as ChevronDown } from "./chevron-down-B_yefpkv.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex h-full flex-col px-4 pt-[env(safe-area-inset-top,44px)] text-white", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto pb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "flex items-center gap-2 text-[24px] font-extrabold leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-5 w-5 text-[#8b7aff]", fill: "#8b7aff", strokeWidth: 2.5 })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: (e) => {
            e.stopPropagation();
            onFork();
          }, disabled: forking, className: "pressable flex h-[26px] items-center justify-center gap-1 rounded-full border border-violet-300 bg-violet-50 px-2.5 text-[10px] font-bold text-violet-600 disabled:opacity-70", title: "收藏为我的行程", children: [
