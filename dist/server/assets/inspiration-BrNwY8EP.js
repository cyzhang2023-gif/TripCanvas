...
import { P as Plus, C as Compass, B as BottomNav } from "./BottomNav-CwAE44uA.js";
import { f as useFeaturedRoutes } from "./tripStore-DdmMBjKa.js";
import { C as ChevronLeft } from "./chevron-left-CnjU-cre.js";
import { H as Heart } from "./heart-CRqbJF1t.js";
import { S as Share2, C as ChevronDown } from "./share-2-VJKzsdej.js";
...
import { F as Flame } from "./flame-BTynHlf7.js";
...
function pickBubbles(pool, count) {
  const shuffled = [...pool].sort(() => Math.random() - 0.5);
  const picked = [];
  for (const b of shuffled) {
    const tooClose = picked.some((p) => Math.abs(p.left - b.left) < 17 && Math.abs(p.top - b.top) < 17);
    if (!tooClose) {
      picked.push(b);
...
function InspirationMap() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell min-h-screen bg-[#f5f6fa] pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-3 mt-2 overflow-hidden rounded-[20px] shadow-md", style: {
      height: 340
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[#e9f1f7]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 1000 500", className: "h-full w-full", preserveAspectRatio: "xMidYMid slice", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "ocean", cx: "50%", cy: "50%", r: "70%", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#e9f3fa" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#d5e6f2" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "1000", height: "500", fill: "url(#ocean)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { stroke: "#c2d8e8", strokeWidth: "0.4", fill: "none", opacity: "0.4", strokeDasharray: "6 4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "0", y1: "125", x2: "1000", y2: "125" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "0", y1: "250", x2: "1000", y2: "250" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "0", y1: "375", x2: "1000", y2: "375" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "250", y1: "0", x2: "250", y2: "500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "500", y1: "0", x2: "500", y2: "500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "750", y1: "0", x2: "750", y2: "500" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "#b6ced9", stroke: "#96b5c6", strokeWidth: "0.6", strokeLinejoin: "round", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M45,75 L70,62 L115,58 L160,48 L210,45 L255,52 L290,58 L330,92 L318,112 L305,130 L290,148 L275,178 L255,168 L235,178 L218,192 L228,212 L215,218 L195,200 L178,165 L160,130 L152,112 L130,92 L85,78 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M340,32 L375,25 L400,35 L395,56 L368,60 L342,50 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M215,218 L228,212 L240,222 L248,232 L238,238 L225,232 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M238,238 L265,228 L305,225 L350,232 L385,248 L402,268 L398,298 L382,322 L358,348 L328,368 L318,398 L308,380 L312,348 L298,315 L282,282 L278,255 L258,240 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M412,50 L428,46 L438,52 L432,60 L418,58 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M448,88 L458,78 L465,85 L462,98 L452,100 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M442,90 L448,84 L450,92 L444,96 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M465,85 L478,72 L498,74 L518,82 L538,75 L558,68 L572,72 L568,88 L558,98 L548,108 L540,118 L530,128 L548,135 L562,142 L555,150 L540,142 L525,128 L510,118 L500,108 L492,118 L478,125 L468,120 L460,108 L465,95 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M478,42 L492,38 L502,45 L508,58 L498,74 L488,68 L478,55 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M455,172 L478,165 L510,168 L535,178 L548,198 L555,225 L552,258 L542,295 L525,328 L505,352 L480,358 L462,345 L448,310 L440,268 L438,228 L445,195 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M568,310 L575,298 L580,312 L575,325 L568,318 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M558,168 L580,158 L598,172 L595,192 L582,198 L565,188 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M628,130 L648,125 L662,142 L668,168 L658,198 L642,215 L628,205 L622,178 L618,155 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M648,218 L655,212 L658,222 L652,226 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M572,72 L598,55 L640,48 L685,42 L720,48 L755,58 L780,72 L790,92 L785,115 L772,130 L755,138 L735,142 L715,135 L695,125 L675,118 L662,125 L648,125 L628,130 L618,120 L600,108 L585,95 L572,82 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M695,155 L710,148 L725,158 L735,175 L728,195 L715,205 L700,195 L695,175 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M700,232 L718,225 L728,235 L720,245 L705,240 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M725,248 L745,242 L755,250 L742,258 L728,255 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M728,218 L748,212 L758,225 L748,235 L732,228 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M762,178 L770,168 L778,178 L775,192 L768,195 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M798,88 L808,78 L815,88 L812,108 L802,112 L795,102 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M778,148 L784,142 L788,150 L783,156 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M762,318 L808,305 L848,312 L872,332 L868,362 L842,385 L802,382 L772,365 L758,342 Z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M882,378 L888,368 L895,378 L892,392 L885,395 Z" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/5 to-white/20" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-14 right-3 z-10 flex flex-col gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "flex h-8 w-8 items-center justify-center rounded-lg bg-white text-gray-600 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "flex h-8 w-8 items-center justify-center rounded-lg bg-white text-gray-600 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-4 w-4" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute bottom-3 right-3 z-10 flex h-8 w-8 items-center justify-center rounded-lg bg-white text-gray-500 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-primary" }) }),
      displayBubbles.map((bubble) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/explore", search: {
        ...
        }, className: "absolute z-[6] flex flex-col items-center transition-transform active:scale-90", style: {
          top: `${bubble.top}%`,
          left: `${bubble.left}%`,
          transform: "translate(-50%,-50%)"
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-full shadow-lg", style: {
            width: px,
            height: px,
            border: isLg ? "3px solid rgba(67,97,238,0.45)" : "2.5px solid white",
            boxShadow: isLg ? "0 0 0 3px rgba(67,97,238,0.18), 0 4px 12px rgba(0,0,0,0.15)" : "0 3px 10px rgba(0,0,0,0.12)"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 text-center text-[10px] font-bold text-gray-800", style: {
