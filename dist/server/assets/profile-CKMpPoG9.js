...
import { u as useNavigate, L as Link } from "./router-_rLCEenn.js";
import { C as Calendar, B as BottomNav } from "./BottomNav-BNMZze1E.js";
import { d as useTrips } from "./tripStore-CAEye6oe.js";
...
import { P as Pencil, X } from "./x-DGENQlpv.js";
...
import { B as Bell } from "./bell-BnZ4U-sf.js";
...
function Profile() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell bg-[#faf8f6] pb-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-3 flex items-center gap-3 rounded-2xl p-4 cursor-pointer active:opacity-90", style: {
      background: "linear-gradient(135deg, #fff0ed 0%, #fde8e2 100%)"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-16 overflow-hidden rounded-full bg-white/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full rounded-full transition-all", style: {
          width: `${progress}%`,
          background: "linear-gradient(90deg, #e8614d, #d4432e)"
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-7 w-7 place-items-center rounded-full bg-white/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-3.5 w-3.5 text-[#d4532e]" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 px-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TravelCard, { icon: Clock, label: "浏览历史", sub: `${trips.length} 条记录`, color: "text-[#e8614d]", bg: "bg-[#fff0ed]", onClick: () => nav({
          to: "/my-trips"
        }) })
      ] })
    ] }),
    ...
    showEditProfile && /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { title: "编辑资料", onClose: () => setShowEditProfile(false), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        ...
        background: "linear-gradient(135deg, #e8614d, #c44a2d)"
      }, children: "保存" })
    ] }),
    ...
    showStats && /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { title: "旅行统计", onClose: () => setShowStats(false), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2.5 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "总行程", value: String(trips.length), sub: "条", color: "from-primary to-[#d4532e]" }),
      ...
      Object.keys(catCounts).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 space-y-1.5", children: Object.entries(catCounts).sort(([, a], [, b]) => b - a).map(([cat, count]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full rounded-full bg-gradient-to-r from-primary to-[#e8614d]", style: {
