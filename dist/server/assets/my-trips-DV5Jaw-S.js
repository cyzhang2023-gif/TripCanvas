...
import { f as useTripsQuery, a as useTripActions, c as coverUrl } from "./tripStore-CAEye6oe.js";
...
function TripCard({
  ...
  const statusStyle = trip.status === "进行中" ? "bg-[#e8614d]/90" : trip.status === "已完成" ? "bg-gray-400/90" : "bg-amber-500/90";
