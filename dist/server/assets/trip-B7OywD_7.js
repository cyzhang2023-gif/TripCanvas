...
import { R as Route, L as Link } from "./router-D-67bGNW.js";
import { P as Plus, B as BottomNav } from "./BottomNav-B3kl0Tsd.js";
import { X, P as Pencil } from "./x-Bw5J3Wt-.js";
...
import { T as Trash2 } from "./trash-2-BVB344Kb.js";
import { C as ChevronLeft } from "./chevron-left-DlV_M45D.js";
import { C as ChevronRight } from "./chevron-right-c6n95luU.js";
import { h as hasUserRated, S as StarRating, R as RATING_TAGS, a as addRating, b as RatingSummary } from "./RatingSummary-Cfh5zWG_.js";
import { u as useTripQuery, a as useTripActions, c as coverUrl, b as useTravelInfo } from "./tripStore-D1dKS6e8.js";
...
import { H as Hotel, C as ChevronUp } from "./hotel-qmzEFC66.js";
...
function loadMapLibre() {
  ...
  if (!_mlglPromise) {
    _mlglPromise = Promise.all([
      import("./maplibre-gl-CK5bJ_ZR.js").then((n) => n.m),
      Promise.resolve({                })
    ]).then(([mod]) => {
      _mlgl = mod;
      return mod;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-6 w-6 items-center justify-center rounded-full bg-violet-100 text-violet-600 transition-transform group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-3.5 w-3.5", strokeWidth: 3 }) }),
          "添加地点"
        ]
      }
    ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: categories$1.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `rounded-full px-3.5 py-1.5 text-[12px] font-semibold transition-all ${category === cat ? "bg-violet-600 text-white shadow-md shadow-violet-200" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`,
                    children: cat
                  },
                  cat
                )) })
            ...
            success ? /* @__PURE__ */ jsxRuntimeExports.jsx(SuccessView, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto px-6 pb-8", style: { maxHeight: "calc(85vh - 48px)" }, children: [
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        background: isSelected ? "linear-gradient(135deg, #8b5cf6, #6366f1)" : "white",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: score > 0 ? "linear-gradient(135deg, #8b5cf6, #4f46e5)" : "#d1d5db",
                    boxShadow: score > 0 ? "0 8px 24px rgba(79,70,229,0.3)" : "none"
                  },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-3 mb-2 overflow-hidden rounded-2xl bg-white px-3.5 py-3 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex flex-wrap items-center gap-1.5", children: [
        ...
        trip.sourceRouteId && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-0.5 rounded-full bg-gradient-to-r from-violet-50 to-pink-50 px-2 py-0.5 text-[10px] font-medium text-violet-600", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-8 pt-4", children: [
        ...
        introText && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 rounded-full bg-violet-500/20 px-2 py-0.5 text-[10px] font-semibold text-violet-300", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            introIsLong && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIntroExpanded(!introExpanded), className: "mt-1 flex items-center gap-1 text-[11px] font-semibold text-violet-400 active:text-violet-300", children: introExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              "收起 ",
