...
import { P as Plus, C as Compass, B as BottomNav } from "./BottomNav-CKJgexq0.js";
import { f as useFeaturedRoutes } from "./tripStore-CSViccBP.js";
import { C as ChevronLeft } from "./chevron-left-74rf95ou.js";
import { H as Heart } from "./heart-Brr0BvFa.js";
import { S as Share2, C as ChevronDown } from "./share-2-7ntld2U9.js";
...
import { F as Flame } from "./flame-9x_RLiuV.js";
...
function InspirationMap() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell min-h-screen bg-[#f5f6fa] pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-3 mt-2 overflow-hidden rounded-[20px] shadow-md", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/api/spot-image?q=world+map+watercolor+pastel+illustration", alt: "map bg", className: "absolute inset-0 h-full w-full object-cover", style: {
        filter: "brightness(1.06) saturate(0.85)"
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-white/25" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-[5]", style: {
        top: "58%",
        left: "44%",
        transform: "translate(-50%,-50%)"
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-5 w-5 text-primary drop-shadow-md", fill: "currentColor" }) }),
