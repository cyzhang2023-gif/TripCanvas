...
import { P as Plus, C as Compass, B as BottomNav } from "./BottomNav-UfdrS_FC.js";
import { f as useFeaturedRoutes } from "./tripStore-DAlCUYA5.js";
import { C as ChevronLeft } from "./chevron-left-BqgBHhVJ.js";
import { H as Heart } from "./heart-DFDfsI-B.js";
import { S as Share2, C as ChevronDown } from "./share-2-D9QrxM0r.js";
...
import { F as Flame } from "./flame-BvepBQsv.js";
...
function InspirationMap() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell min-h-screen bg-[#f5f6fa] pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-3 mt-2 overflow-hidden rounded-[20px] shadow-md", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[#dce8f0]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/world-map.svg?v=3", alt: "", className: "h-full w-full object-cover", draggable: false }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/5 to-white/15" }),
