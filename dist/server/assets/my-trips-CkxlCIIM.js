...
import { f as useTripsQuery, a as useTripActions, c as coverUrl } from "./tripStore-D1dKS6e8.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell pb-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-start justify-between px-4 pt-5 pb-0.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 pt-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pressable flex h-8 w-8 items-center justify-center rounded-full bg-card shadow-sm", "aria-label": "搜索", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-3.5 w-3.5 text-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pressable flex h-8 w-8 items-center justify-center rounded-full bg-card shadow-sm", "aria-label": "更多选项", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ellipsis, { className: "h-3.5 w-3.5 text-foreground" }) })
      ] })
    ] }),
...
function TripCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "relative overflow-hidden rounded-[18px] shadow-[0_10px_26px_rgba(38,43,70,.10)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Img, { src: trip.coverUrl || coverUrl(trip.cover, trip.country, trip.destination), alt: trip.name, loading: "lazy", wrapperClass: "absolute inset-0", className: "h-full w-full object-cover" }),
