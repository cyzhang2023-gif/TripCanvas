...
import { u as useNavigate, b as Route, L as Link } from "./router-C4teJ7Oq.js";
import { e as useImportJob } from "./tripStore-YDHZIwB5.js";
import { C as ChevronLeft } from "./chevron-left-7A3NdEFE.js";
import { R as Route$1 } from "./route-CHy8ckiy.js";
...
function Parsing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell pb-10", style: {
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-col items-center gap-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
