...
import { C as Compass, B as BottomNav } from "./BottomNav-TMuimeef.js";
import { f as useFeaturedRoutes } from "./tripStore-C8RqXxG5.js";
...
const CANVAS_H = MAP_CANVAS_W * 550 / 1e3;
const S0 = 100 / MAP_CANVAS_W;
const S1 = 0.82;
function computeViews(ar) {
  function view(cx, cy, s) {
    return {
      scale: s,
...
function InspirationMap() {
  ...
  const [containerAR, setContainerAR] = reactExports.useState(1.35);
  ...
  const continentViews = reactExports.useMemo(() => computeViews(containerAR), [containerAR]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell min-h-screen bg-[#f5f6fa] pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: mapRef, className: "relative mx-3 mt-2 overflow-hidden rounded-[20px] bg-[#c8e1f0] shadow-md", style: {
      height: 260
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/world-map.svg?v=4", alt: "", className: "absolute inset-0 h-full w-full", draggable: false }),
