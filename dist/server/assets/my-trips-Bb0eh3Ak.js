...
import { L as Link } from "./router-Bldpq11F.js";
import { B as BottomNav } from "./BottomNav-Cqvg-XLz.js";
import { e as useTripsQuery, a as useTripActions, c as coverUrl } from "./tripStore-BtBexnhQ.js";
...
import { T as Trash2 } from "./trash-2-CDtSO6PP.js";
...
function TripCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "relative overflow-hidden rounded-[18px] shadow-[0_10px_26px_rgba(38,43,70,.10)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: coverUrl(trip.cover), alt: trip.name, loading: "lazy", className: "absolute inset-0 h-full w-full object-cover" }),
